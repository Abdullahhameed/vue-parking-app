...
export const useParking = defineStore("parking", () => {
    ...
    return { form, errors, loading, resetForm, startParking, parkings, getActiveParkings, stopParking, stoppedParkings, 
        getStoppedParkings, parking: parkingDetails, getParking, resetParkingDetails };
});